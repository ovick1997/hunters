...
function hunters_cs_js(){
		...
		wp_enqueue_style( 'hunters-menu', get_template_directory_uri() . '/assets/css/menu-css.css', array(), '1.0.0', 'all' );
		wp_enqueue_style( 'hunters-responsive', get_template_directory_uri() . '/assets/css/responsive.css', array(), '1.0.0', 'all' );
...
add_action('wp_enqueue_scripts','hunters_cs_js');





function hunters_fonts_url(){
...
function hunters_editor_styles() {
...
add_action( 'after_setup_theme', 'hunters_editor_styles' );


//Adding fonts to the Custom Header screen
function hunters_custom_header_fonts() {
...
add_action( 'admin_print_styles-appearance_page_custom-header', 'hunters_custom_header_fonts' );
