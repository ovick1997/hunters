            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="looking_for_left para_default">
                        <h3 style="color: <?php echo esc_html(cs_get_option('fields_4')); ?>"><?php echo cs_get_option('fields_1'); ?></h3>
                ...
                <div class="col-md-6">
                    <div class="looking_for_right image_fulwidth wow fadeInRight" data-wow-delay="300ms">
                        <img src="<?php echo esc_url(wp_get_attachment_image_src(cs_get_option('fields_3'), 'full')[0]); ?>">
                    </div>
                </div>
            </div><!--row -->
        </div><!--container -->
...
<?php 
    ...
    $grp_sec_1 = esc_get_option('fields_group_1');
            ...
            foreach ($grp_sec_1 as  $grp_value_1) { ?>
                <div class="col-md-4 col-sm-6">
                    <div class="choose_us_single para_default image_fulwidth text-center wow fadeInLeft" data-wow-delay="300ms">
                       <img src="<?php echo esc_url(wp_get_attachment_image_src(cs_get_option($grp_value_1['fields_7']), 'full')[0]); ?>">
